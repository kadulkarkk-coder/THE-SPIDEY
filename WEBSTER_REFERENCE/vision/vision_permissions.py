"""Permission policy for visual data collection and processing."""
from __future__ import annotations


class VisionPermissions:
    """Explicit capability grants for camera, screenshot and visual analysis."""
